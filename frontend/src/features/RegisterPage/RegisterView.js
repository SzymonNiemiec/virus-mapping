        ...
        <Formik
            ...
            {({
                ...
                <Form onSubmit={handleSubmit}>
                    <Title>Hello,<br/> Nice to see you</Title>
                        <Input name="email" type="email" label="E-mail" value={values.email} onChange={handleChange} />
                        <Input name="name" type="name" label="Name" value={values.name} onChange={handleChange} />
                        <CenterBox>
                            <StyledButton type='submit' variant='primary'>Sign up</StyledButton>
                        </CenterBox>
                    </Form>
                )
            }
